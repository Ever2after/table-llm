...
def get_custom_processor(max_cell_length, max_input_length, target_delimiter=', '):
    ...
    table_truncate_funcs = [
        CustomCellLimitTruncate(max_cell_length=max_cell_length,
                          tokenizer=AutoTokenizer.from_pretrained(pretrained_model_name_or_path="Qwen/Qwen2.5-Coder-14B-Instruct"), 
...
def get_default_processor(max_cell_length, max_input_length, target_delimiter=', '):
    ...
    table_truncate_funcs = [
        CellLimitTruncate(max_cell_length=max_cell_length,
                          tokenizer=AutoTokenizer.from_pretrained(pretrained_model_name_or_path="Qwen/Qwen2.5-Coder-14B-Instruct"), # facebook/bart-large
                          max_input_length=max_input_length),
