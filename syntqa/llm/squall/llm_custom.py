...
file_path = "predict/tablebench_classifier_test3.csv"
...
def call_model(cur_prompt, stop, temperature = 0.1, system_prompt = None):
...
for i, row in df.iterrows():
    ...
    table = 'header: ' + row['input_tokens'].split('col : ')[1].split('\n')[0]
