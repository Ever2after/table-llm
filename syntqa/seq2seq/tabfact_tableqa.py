...
def preprocess_function(
    ...
    for i in range(len(examples['statement'])):
        # (1) 문제, 정답, 테이블 정보 가져오기
        question = "Based on given table, check the following statement is true or false. Statement: " + examples['statement'][i] + "\n"
...
if __name__ == '__main__':
    ...
    dataset_dict = load_dataset("task/tabfact.py")  # or {"train":..., "test":...}
