...
class Generator(object):
    ...
    def __init__(self, args, keys=None):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.mode_name)
    ...
    def generate_one_pass(
        ...
        print(f'LLM one inference time: {time.time() - start_time}')
        ...
        while result is None:
            try:
                ...
                if is_chat:
                    ...
                    print('LLM inference time:', time.time() - start_time)
                    return result
